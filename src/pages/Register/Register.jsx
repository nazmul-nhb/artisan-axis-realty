...
const Register = () => {
    ...
    return (
        <div className="p-4 text-teal-900">
            <section className="space-y-6 flex flex-col justify-center items-center">
                <form onSubmit={handleSubmit(handleRegister)} className="flex flex-col gap-6 w-1/2 px-20 py-10 bg-white shadow-lg shadow-[#3c3939] border border-[#d3d0d0] rounded-md">
                    ...
                    <Button buttonType={'submit'} className={'w-full'} buttonText={'Register'} color={'teal'} hoverColor={'white'} hoverBgColor={'transparent'}></Button>
