                    ...
                    <div className="space-y-8 px-3 py-2 border border-[#d4d4d4] rounded-lg">
                        ...
                        <div className="flex flex-col lg:flex-row justify-between gap-6">
                            ...
                            <div className="w-full lg:w-2/5 flex justify-between items-center">
                                <div>
                                    <Button onClick={() => saveToLocal(selectedEstate.id, 'estates')} className={'border font-semibold'} buttonText={'Add to Favorites'} color={`${status === 'sale' ? '#16a34a' : '#ea580c'}`} hoverColor={'white'} hoverBgColor={'transparent'}></Button>
                                </div>
                                <div>
                                    <Button onClick={() => { setShowModal(true); removeFromLocal(selectedEstate.id, 'estates') }} className={'border font-semibold'} buttonText={`${status === 'sale' ? 'Buy Now' : 'Rent Now'}`} color={`${status === 'sale' ? '#16a34a' : '#ea580c'}`} hoverColor={'white'} hoverBgColor={'transparent'}></Button>
                                </div>
                            </div>
                        </div>
                        {
