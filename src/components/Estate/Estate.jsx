...
const Estate = ({ estate }) => {
    ...
    return (
        <div data-aos="zoom-in-down" data-aos-duration="1000" data-aos-delay="1000" className={`flex flex-col gap-3 border p-4 rounded-lg shadow-md ${status === 'sale' ? 'shadow-[#16a34a]' : 'shadow-[#ea580c]'}`}>
            <Link to={`/${id}`}>
